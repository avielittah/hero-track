  ...
  return <div className="min-h-screen bg-background relative">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl" dir="ltr">
        ...
        y: 0
            ...
            <StageSummary title="🎯 Stage 7 Summary" completedUnits={units.filter(u => u.isCompleted)} totalXP={earnedXP} keyLearnings={["Professional diagram creation with Draw.io", "Advanced media analysis using VLC", "Browser-based tool collaboration", "Engineering diagnostic methodologies"]} nextSteps={["Apply these tools in real engineering scenarios", "Collaborate on team diagrams", "Use VLC for media troubleshooting"]} />
          </motion.div>}
        ...
        y: 0
            ...
            <StageFeedback stageNumber={7} onSubmit={setStageFeedback} />
          </motion.div>}
